...
To get the diff between two versions, go to https://github.com/LIN3S/WPFoundation/compare/v1.6.4...v2.0.0

* 2.0.0
    * The minimum requirement for PHP is the 7.1 version.
    * Removed 1.* versions deprecated code.
* 1.6.2, 1.6.3, 1.6.4
    * Fixed minor typos
* 1.6.1
